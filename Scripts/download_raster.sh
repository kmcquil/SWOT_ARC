...
# Example command: 
# ./download_raster.sh  2023-01-01T00:00:00Z 2024-07-07T23:59:59Z \*162_045F\*
...
podaac-data-downloader -c SWOT_L2_HR_Raster_2.0 -d /projects/swot/Data/SWOT_L2_HR_Raster_2.0/ --start-date $1 --end-date $2 --granule-name $3
